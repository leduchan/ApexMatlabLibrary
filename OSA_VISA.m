...
classdef OSA_VISA < handle
   ...
   methods
       function obj = OSA_VISA(IPaddress,PortNumber)
      ...
      function StartWavelength = GetStartWavelength(obj)
         % Get the start wavelength of the measurement span
         % Wavelength is expressed in nm
         Command = "SPSTRTWL?\n";
         fprintf(obj.Session, Command);
         StartWavelength = fscanf(obj.Session,'%f');
      end
      ...
      function StopWavelength = GetStopWavelength(obj)   
        % Get the stop wavelength of the measurement span
        % Wavelength is expressed in nm
        Command = "SPSTOPWL?\n";    
        fprintf(obj.Session, Command);
        StopWavelength = fscanf(obj.Session,'%f') ;        
      end
      ...
      function Span=GetSpan(obj)
            ...
            Command = "SPSPANWL?\n" ;
            fprintf(obj.Session, Command) ;
            Span = fscanf(obj.Session,'%f') ;        % Reading the txt data from APEX OSA  
      end
      ...
      function Center = GetCenter(obj)
            ...
            Command = "SPCTRWL?\n";
            fprintf(obj.Session, Command) ;
            Center = fscanf(obj.Session,'%f') ;        % Reading the txt data from APEX OSA  
      end
      ...
      function Resolution = GetXResolution(obj)
        % Get the wavelength measurement resolution
        % Resolution is expressed in the value of 'ScaleXUnit'
        Command = "SPSWPRES?\n";
        fprintf(obj.Session, Command);
        Resolution = fscanf(obj.Session,'%f') ;        % Reading the txt data from APEX OSA  
      end
...
%       function GetPolarizationMode(obj)
% %         '''
